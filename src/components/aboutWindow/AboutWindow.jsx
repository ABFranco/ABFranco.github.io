  ...
  return (
    <div className="about-window">
      <div className="window-bar">
        <div
          className="dot red"
          onClick={() => handleNavigation("/")} // navigate back to home
        ></div>
        <div
          className="dot amber"
          onClick={() => handleNavigation("/")} // navigate back to home
      ...
      <div className="about-content">
        ...
        <Typography variant="body1">
          I am passionate for programming and building innovative solutions. My
          career aspirations mainly include web development, software
          engineering, and UX design. I aim for continuous personal growth,
          driven by the desire to learn new technologies and best practices in
